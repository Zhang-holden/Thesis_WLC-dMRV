...
## 4. 新西兰市场分析：基于 VMD0049 Positive List 的资格判定与市场启示

### 4.1 新西兰在 VMD0049 中的核心数据

根据 VMD0049 v2.0 draft (2026) 中的 Table 1 及 Appendix A，新西兰 (New Zealand) 的轻型车 (LDV) 电动化数据如下（数据来源：IEA Global EV Outlook 2025）：

| 指标 | 数值 | 全球/区域排名参照 |
|------|------|------------------|
| **EV 保有量占比 (Stock Share, 2024)** | **3.3%** | 高于韩国 (2.8%)、美国 (2.7%)、澳大利亚 (1.9%) |
| **EV 销量占比 2022** | 18% | — |
| **EV 销量占比 2023** | 27% | 快速上升期 |
| **EV 销量占比 2024** | 11% | 大幅回落 |
| **三年平均销量占比 (2022-2024)** | **18.7%** | 高于全球平均 (18.3%) |

重型车 (HDV) 方面：

| 车辆类型 | EV 保有量占比 (2024) | 数据来源 |
|----------|----------------------|---------|
| **电动巴士 (Buses)** | **1.0%** | Appendix A, HDV Stock Share |
| **电动卡车 (Trucks)** | 未上榜 | 未出现在 Table 2 及 Appendix A 卡车列表 |

### 4.2 VCS 碳信用资格判定

根据 VMD0049 Table 1 和 Table 2，新西兰不同充电类型的 VCS 额外性资格如下：

| 充电类型 | Stock Share 门槛 | 新西兰值 | Sales Share 门槛 | 新西兰值 | **资格判定** |
|----------|-------------------|----------|-------------------|----------|------------|
| **DCFC (直流快充)** | < 5% | 3.3% OK | < 20% | 18.7% OK | **有资格** |
| **AC L1/L2 (交流慢充)** | < 2.5% | 3.3% NO | < 10% | 18.7% NO | **无资格** |
| **电动巴士充电** | < 2.5% | 1.0% OK | — | — | **有资格** |
| **电动卡车充电** | < 5% | 极低 OK | — | — | 理论有资格但市场不存在 |
